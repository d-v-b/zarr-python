...
- **A pull request opens with a sentence your operator wrote.** Do not write it, and do not draft one for them to paste — the operator must state the motivation in their own words. Leave a placeholder saying so. You may draft the detail that follows, labeled.
