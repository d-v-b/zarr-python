...
from zarr.metadata.common import ArrayMetadataBase, parse_attributes
from zarr.metadata.v3 import RegularChunkGrid


def parse_filters(data: list[Mapping[str, JSON]] | None) -> list[Mapping[str, JSON]] | None:
    return data
