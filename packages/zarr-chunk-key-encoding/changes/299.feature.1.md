Added `BoundedChunkKeyEncoding` and `ChunkKeyEncoding.bind_grid_shape`: an encoding
...
It also has a JSON form, `{"grid_shape": [...], "chunk_key_encoding": ...}`,
via `to_json` / `from_json`, typed as `BoundedChunkKeyEncodingJSON`.
